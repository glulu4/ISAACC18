      ...
      <div className="py-44">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center sm:mt-10">
                  ...
                  <h2 className="text-header1 text-center ">
                      ISAACC18 Board of Directors
                  </h2>
                  {/* <p className=" text-body1 mt-10 text-gray-600">
              ...
              >
                  {people.map((person, idx) => (
                    //   <li key={idx} className="flex flex-col gap-6 xl:flex-row">
                    //       <Image 
                    //       width={500}
                    //         height={500}
                    //       alt="team member image" src={person.imageUrl} className="aspect-4/5 w-72 flex-none rounded-2xl object-cover" />
                    //       <div className="flex-auto">
                    //           <h3 className=" text-blue-950 font-serif text-lg/8 sm:text-2xl font-semibold tracking-tight ">{person.name}</h3>
                    //           <p className="text-base/7 text-gray-600">{person.role}</p>
                    //           <p className="mt-6 text-base/7 font-medium text-pretty sm:text-xl/9 text-gray-600">
                    //           {person.bio}
                    //           </p>
                    //       </div>
                    //   </li>
                      ...
                      >
                          ...
                          {/* <Image
                              ...
                              src={person.imageUrl}
                              className="w-full sm:w-64 sm:h-auto rounded-2xl object-cover"
                          /> */}
                          <Image
                              src={person.imageUrl}
                              alt={`Photo of ${person.name}`}
